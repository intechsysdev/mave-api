...
namespace ECM.Infraestructura.Datos.Repositories.ModuloSeg
{
    ...
    public class EcmRterminosusoRepository : Repository<EcmRterminosuso>, IEcmRterminosusoRepository
    {
        public EcmRterminosusoRepository(IUnitOfWorkSEG unitOfWork) : base(unitOfWork)
        {
