...
{
    public class MobRordHeadCustRepository : Repository<MobRordHeadCust>, IMobRordHeadCustRepository
    {
        public MobRordHeadCustRepository(IUnitOfWorkECM unitOfWork) : base(unitOfWork)
        {

        }

        //public IQueryable<MobRordHeadCust> ConsultarPedido(string cmpy, string cust, string succli)
        //{
